      ...
      <div class=" tw-w-full  tw-h-full tw-rounded-b-2xl tw-overflow-hidden tw-flex
       tw-select-none" @contextmenu.prevent="mr_clicked">
        <div class=" tw-w-52 tw-bg-white tw-h-full tw-flex tw-flex-col tw-px-3 tw-py-2 tw-flex-none" >
          ...
          <WindowSettingIcon :tag="'架构'" :img="'skills'" :selected_tag="selected_tag"  @click.native="{selected_tag = 'Skills';selected_tag_2 = 'Badges'}"/>
          <WindowSettingIcon :tag="'日志'" :img="'paint'" :selected_tag="selected_tag"  @click.native="selected_tag = 'Resume'"/>
        </div>
          ...
          <div class="tw-w-full tw-h-full  tw-flex">
            <div class="tw-w-48 tw-flex-none tw-rounded-xl tw-bg-white tw-p-2">
              ...
              <div class="tw-w-full tw-h-full" v-if="selected_tag === 'Skills'">
                <WindowSettingIcon :tag="'调用的服务'" :mdi="'shield-half-full'" :selected_tag="selected_tag_2"  @click.native="selected_tag_2 = 'Badges'"/>
                <WindowSettingIcon :tag="'还有一些其他的'" :mdi="'card-account-details-star'" :selected_tag="selected_tag_2"  @click.native="selected_tag_2 = 'And Some Else'"/>
              </div>
            </div>
            <div class="vl"></div>
              ...
              <div class=" tw-w-full tw-h-full" v-if="selected_tag === 'Profile'">
                <div ref="overall_page" class="tw-w-full tw-h-full tw-items-center tw-flex tw-flex-col" style="text-align:center" v-if="selected_tag_2 ==='About Me'">
                  <div class=" tw-w-20 tw-h-20 tw-rounded-full tw-overflow-hidden tw-mt-16">
                    <img src="../../assets/images/luotianyi.png" alt="" class="tw-bg-red-500">
                  </div>
                  <div class="tw-mt-3 tw-text-gray-400">枷锁云-星尘</div>
                  <div class="tw-text-xl tw-mt-2 tw-tracking-wide"> 欢迎来到我的web-deepin！</div>
                  <div class="tw-text-lg tw-mt-2 tw-tracking-wide"> 我的项目：<p><a href="https://xingchencloud.top/">星尘主页</a>&<a href="https://blog.xingchencloud.top/">博客</a>&<a href="https://pan.xingchencloud.top/">网盘</a></p> </div>
                </div>
                <div ref="github_page" class="tw-w-full tw-h-full tw-items-center tw-flex tw-flex-col tw-justify-center" style="text-align:center" v-if="selected_tag_2 ==='Github Stats'">
                  <img src="https://github-readme-stats.vercel.app/api?username=Gasolcloudteam&show_icons=true&line_height=24" alt="" class="tw-w-140 tw-h-40">
                  <img src="https://github-readme-stats.vercel.app/api/top-langs?username=gasolcloudteam" alt="" class="tw-mt-6  tw-w-120 tw-h-72">
                </div>
                <div ref="github_page" class="tw-w-full tw-h-full tw-items-center tw-flex tw-flex-col" style="text-align:center" v-if="selected_tag_2 ==='CodeWars'">
                  ...
                  <img src="https://www.codewars.com/users/Gasolcloudteam/badges/large" alt="" class="tw-mt-10">
                </div>
              </div>
              <div class="tw-w-full tw-h-full" v-if="selected_tag === 'Skills'">
                <div ref="overall_page" class="tw-w-full tw-h-full tw-items-center tw-flex tw-flex-col tw-justify-center" style="text-align:center" v-if="selected_tag_2 ==='Badges'">
                  <div class="tw-text-xl tw-mt-2 tw-tracking-wide"> 框架 </div>
                  ...
                  <div class="tw-text-xl tw-mt-2 tw-tracking-wide"> 工具 </div>
                  <div class="tw-flex tw-flex-wrap tw-px-4 tw-py-2  tw-items-center">
                  ...
                  <div class="tw-text-xl tw-mt-2 tw-tracking-wide"> 其他 </div>
                ...
                <div ref="github_page" class="tw-w-full tw-h-full tw-items-center tw-flex tw-flex-col tw-justify-center tw-mb-16" style="text-align:center" v-if="selected_tag_2 ==='And Some Else'">
                  ...
                  <div class="tw-text-lg tw-mt-2 tw-tracking-wide tw-mb-10"> 谢谢你观看这个演示，希望你喜欢它。 </div>
                </div> 
              </div>
